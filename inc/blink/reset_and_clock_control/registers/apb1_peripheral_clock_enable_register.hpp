...
namespace reset_and_clock_control
{
    ...
    struct apb1_peripheral_clock_enable_register
    {
        ...
        constexpr u32 get_tim2_clock_enable() const noexcept { return get_bits<enum_mask::TIM2_CLOCK_ENABLE>(m_value); }
        constexpr void set_tim2_clock_enable(u32 value) noexcept
        {
            set_bits<enum_mask::TIM2_CLOCK_ENABLE>(m_value, value);
        }

        constexpr u32 get_tim3_clock_enable() const noexcept { return get_bits<enum_mask::TIM3_CLOCK_ENABLE>(m_value); }
        constexpr void set_tim3_clock_enable(u32 value) noexcept
        {
            set_bits<enum_mask::TIM3_CLOCK_ENABLE>(m_value, value);
        }

        constexpr u32 get_tim4_clock_enable() const noexcept { return get_bits<enum_mask::TIM4_CLOCK_ENABLE>(m_value); }
        constexpr void set_tim4_clock_enable(u32 value) noexcept
        {
            set_bits<enum_mask::TIM4_CLOCK_ENABLE>(m_value, value);
        }

        constexpr u32 get_tim5_clock_enable() const noexcept { return get_bits<enum_mask::TIM5_CLOCK_ENABLE>(m_value); }
        ...
        constexpr u32 get_spi2_clock_enable() const noexcept { return get_bits<enum_mask::SPI2_CLOCK_ENABLE>(m_value); }
        constexpr void set_spi2_clock_enable(u32 value) noexcept
        {
            set_bits<enum_mask::SPI2_CLOCK_ENABLE>(m_value, value);
        }

        constexpr u32 get_spi3_clock_enable() const noexcept { return get_bits<enum_mask::SPI3_CLOCK_ENABLE>(m_value); }
        ...
        constexpr u32 get_i2c1_clock_enable() const noexcept { return get_bits<enum_mask::I2C1_CLOCK_ENABLE>(m_value); }
        constexpr void set_i2c1_clock_enable(u32 value) noexcept
        {
            set_bits<enum_mask::I2C1_CLOCK_ENABLE>(m_value, value);
        }

        constexpr u32 get_i2c2_clock_enable() const noexcept { return get_bits<enum_mask::I2C2_CLOCK_ENABLE>(m_value); }
        constexpr void set_i2c2_clock_enable(u32 value) noexcept
        {
            set_bits<enum_mask::I2C2_CLOCK_ENABLE>(m_value, value);
        }

        constexpr u32 get_i2c3_clock_enable() const noexcept { return get_bits<enum_mask::I2C3_CLOCK_ENABLE>(m_value); }
