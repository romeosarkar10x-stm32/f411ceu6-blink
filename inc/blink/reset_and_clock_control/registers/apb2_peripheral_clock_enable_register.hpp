...
namespace reset_and_clock_control
{
    ...
    struct apb2_peripheral_clock_enable_register
    {
        ...
        constexpr u32 get_tim1_clock_enable() const noexcept { return get_bits<enum_mask::TIM1_CLOCK_ENABLE>(m_value); }
        ...
        constexpr u32 get_adc1_clock_enable() const noexcept { return get_bits<enum_mask::ADC1_CLOCK_ENABLE>(m_value); }
        constexpr void set_adc1_clock_enable(u32 value) noexcept
        {
            set_bits<enum_mask::ADC1_CLOCK_ENABLE>(m_value, value);
        }

        constexpr u32 get_sdio_clock_enable() const noexcept { return get_bits<enum_mask::SDIO_CLOCK_ENABLE>(m_value); }
        constexpr void set_sdio_clock_enable(u32 value) noexcept
        {
            set_bits<enum_mask::SDIO_CLOCK_ENABLE>(m_value, value);
        }

        constexpr u32 get_spi1_clock_enable() const noexcept { return get_bits<enum_mask::SPI1_CLOCK_ENABLE>(m_value); }
        constexpr void set_spi1_clock_enable(u32 value) noexcept
        {
            set_bits<enum_mask::SPI1_CLOCK_ENABLE>(m_value, value);
        }

        constexpr u32 get_spi4_clock_enable() const noexcept { return get_bits<enum_mask::SPI4_CLOCK_ENABLE>(m_value); }
        ...
        constexpr u32 get_tim9_clock_enable() const noexcept { return get_bits<enum_mask::TIM9_CLOCK_ENABLE>(m_value); }
        ...
        constexpr u32 get_spi5_clock_enable() const noexcept { return get_bits<enum_mask::SPI5_CLOCK_ENABLE>(m_value); }
