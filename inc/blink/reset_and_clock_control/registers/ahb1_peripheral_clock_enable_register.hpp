...
namespace reset_and_clock_control
{
    ...
    struct ahb1_peripheral_clock_enable_register
    {
        ...
        constexpr u32  get_crc_clock_enable() const noexcept { return get_bits<enum_mask::CRC_CLOCK_ENABLE>(m_value); }
        constexpr void set_crc_clock_enable(u32 value) noexcept
        {
            set_bits<enum_mask::CRC_CLOCK_ENABLE>(m_value, value);
        }

        constexpr u32 get_dma1_clock_enable() const noexcept { return get_bits<enum_mask::DMA1_CLOCK_ENABLE>(m_value); }
        constexpr void set_dma1_clock_enable(u32 value) noexcept
        {
            set_bits<enum_mask::DMA1_CLOCK_ENABLE>(m_value, value);
        }

        constexpr u32 get_dma2_clock_enable() const noexcept { return get_bits<enum_mask::DMA2_CLOCK_ENABLE>(m_value); }
